...
npm run check:claims   # 111 assertions that the registries match the docs
...
npm run test:integration   # 493 checks against a real Postgres
...
— 83 checks, including filing a report with the network cut and
